...
const copy = {
  en: { place: 'Shanghai', title: 'A little room to think', body: 'Leave the morning open.\n\nWalk by the river, stop for a coffee, and write down the idea that keeps returning.\n\nSome things only need a little room.', list: 'A slower Sunday', items: ['Pick up a notebook', 'Walk along the river', 'Leave time for nothing'], sample: 'Sample forecast · live updates need a host', demo: 'Website demo · edits last until this page reloads', local: 'Saved in this browser · share the complete card package', unavailable: 'This demo cannot reach host tools.' },
  zh: { place: '上海', title: '留一点空白', body: '把早晨留出来。\n\n沿着江边走走，找一家咖啡店坐下，把那个反复出现的念头写下来。\n\n有些事，只需要一点空白。', list: '慢一点的周日', items: ['带上一本笔记本', '沿江散步', '留一点发呆的时间'], sample: '示例天气 · 实时更新需要宿主', demo: '网页演示 · 编辑保留至本页刷新', local: '保存在本地浏览器 · 可分享完整卡片包', unavailable: '此网页演示无法调用宿主工具。' },
  ja: { place: '上海', title: '少しの余白', body: '朝は予定を入れずに。\n\n川沿いを歩いて、コーヒーを飲みながら、何度も浮かぶ考えを書き留める。\n\n少しの余白があればいい。', list: 'ゆっくり過ごす日曜日', items: ['ノートを持っていく', '川沿いを散歩する', '何もしない時間を残す'], sample: '天気のサンプル · 更新にはホストが必要', demo: 'ウェブデモ · 編集はページの再読み込みまで有効', local: 'このブラウザーに保存 · カードのパッケージを共有できます', unavailable: 'このデモではホストのツールを使えません。' },
  ko: { place: '상하이', title: '작은 여백', body: '아침은 비워 두세요.\n\n강변을 걷고, 커피를 마시며 자꾸 떠오르는 생각을 적어 보세요.\n\n조금의 여백이면 충분해요.', list: '느긋한 일요일', items: ['공책 챙기기', '강변 산책하기', '아무것도 하지 않을 시간 남기기'], sample: '예시 날씨 · 실시간 업데이트에는 호스트가 필요해요', demo: '웹 데모 · 편집은 페이지를 새로고침할 때까지 유지돼요', local: '이 브라우저에 저장 · 카드 패키지를 공유할 수 있어요', unavailable: '이 데모에서는 호스트 도구를 사용할 수 없어요.' },
};
